...
public class FileMgr {
    ...
    public long avgReadTime() {
        System.out.println("total read time: " + readTotalTime);
        System.out.println("total read count: " + readCnt);
        return readTotalTime / readCnt;
    }

    public long avgWriteTime() {
        System.out.println("total write time: " + writeTotalTime);
        System.out.println("total write count: " + writeCnt);
        return writeTotalTime / writeCnt;
    }
    ...
    public void printStatistics() {
        ...
        // output operating system because different OS use
        // different file system and it does affect I/O time.

        System.out.println("Operating system : " + System.getProperty("os.name") + "\n");
        System.out.println("average read time : " + avgReadTime() + " ns");
        System.out.println("================================");
        System.out.println("average write time : " + avgWriteTime() + " ns");
        System.out.println("================================");
        System.out.println("average write + read time : " + (writeTotalTime / writeCnt + readTotalTime / readCnt) / 2 + " ns");
